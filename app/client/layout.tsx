...
import { Calendar, Clock, Heart, HelpCircle, Menu, X } from "lucide-react"
import NextLink from "next/link"
import { usePathname } from "next/navigation"
import { cn } from "@/lib/utils"

const navigation = [
  { name: "Book a Slot", href: "/client", icon: Calendar },
  { name: "My Booking", href: "/client/my-booking", icon: Clock },
  { name: "Preferences", href: "/client/preferences", icon: Heart },
